...
<div class="page-wrapper">
    ...
    <div class="error-wrapper">
        <div class="container">
            <img src="{{ asset('assets') }}/dashboard/images/sad.png" class="img-100" alt="">
            <div class="error-heading">
                <img src="{{ asset('assets') }}/dashboard/images/cloud-bg-1.png" class="cloud-first" alt="">
                <h2 class="headline font-danger">404</h2>
                <img src="{{ asset('assets') }}/dashboard/images/cloud-bg-2.png" class="cloud-second" alt="">
            </div>
            ...
            <div class="">
                <a href="index.html" class="btn btn-danger-gradien btn-lg">BACK TO HOME PAGE</a>
            </div>
        </div>
    </div>
    <!--error-404 end-->
